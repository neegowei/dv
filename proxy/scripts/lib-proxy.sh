...
ENVSUBST_VARS='$DOMAIN_WWW $DOMAIN_ADMIN $DOMAIN_WWW_CERT_NAME $DOMAIN_ADMIN_CERT_NAME $WEB_UPSTREAM $ADMIN_UPSTREAM $CERT_NAME $DOMAIN_MONITOR $DOMAIN_STORE $DOMAIN_ADMIN_STORE $DOMAIN_MONITOR_CERT_NAME $DOMAIN_STORE_CERT_NAME $DOMAIN_ADMIN_STORE_CERT_NAME $GRAFANA_UPSTREAM $STORE_UPSTREAM $ADMIN_STORE_UPSTREAM'
